...
public class App {
    ...
    */
    static int menu() {
        ...
        // TODO: adicione aqui a opção 9, "Exibir histórico de compras de um cliente"
    ...
    static <K> void listarTodosOsClientes(AVL<K, Cliente> clientesCadastrados) {
    	
        cabecalho();
        System.out.println("\nCLIENTES CADASTRADOS:");
        System.out.println(clientesCadastrados.toString());
    }
    ...
    public static void pedidosDoCliente() {
        ...
        listarTodosOsClientes(clientesPorId);
        int idCliente = lerOpcao("Escolha um Cliente: ", Integer.class);
        Lista<Pedido> pedidosDoCliente;
        ...
        try {
        	...
        	pedidosDoCliente = pedidosPorCliente.pesquisar(cliente);
        	arquivoRelatorio.append(pedidosDoCliente.toString() + "\n");
            arquivoRelatorio.close();
            System.out.println("Dados salvos em " + nomeArquivo);
        } catch(IOException excecao) {
            System.out.println("Problemas para criar o arquivo " + nomeArquivo + ". Tente novamente");        	
